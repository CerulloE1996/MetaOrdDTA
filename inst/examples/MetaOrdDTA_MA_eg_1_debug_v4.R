...
#             }
#             ##
#             priors$prior_beta_mu_mean <- matrix(0.0, nrow = 2, ncol = n_covariates)
...
#   
#         priors$prior_beta_mu_mean <- matrix(0.0, nrow = 2, ncol = n_covariates)
#         priors$prior_beta_mu_SD   <- matrix(5.0, nrow = 2, ncol = n_covariates)
#         priors$prior_beta_SD_mean <- rep(0.0, 2)
#         priors$prior_beta_SD_SD   <- rep(beta_SD_prior, 2)
#         ##
#         priors$prior_raw_scale_mu_mean <- matrix(0.0, nrow = 2, ncol = n_covariates)
#         priors$prior_raw_scale_mu_SD   <- matrix(1.0, nrow = 2, ncol = n_covariates)
#         priors$prior_raw_scale_SD_mean <- rep(0.0, 2)
#         priors$prior_raw_scale_SD_SD   <- rep(raw_scale_SD_prior, 2)
#         ##
#         priors$prior_boxcox_lambda_mean <- 0.00
#         priors$prior_boxcox_lambda_SD   <- 1.00
#         for (kk in 1:n_chains) {
#           
#           # mat <- matrix(-3.0, nrow = n_studies, ncol = n_thr)
#           # init_lists_per_chain[[kk]]$C_raw <-  list(mat, mat)
...
#           init_lists_per_chain[[kk]]$beta_corr <- 0.001
#           ##
#           init_lists_per_chain[[kk]]$raw_scale_mu <- matrix(nrow = 2, c(-1.01, +1.01))
...
#           ##
#           init_lists_per_chain[[kk]]$lambda <- rep(0.001, 2)
# 
#           
#         }
#         
