...
create_summary_and_traces <- function(    model_results,
 ...
 #   pars_names <- init_object$init_vals_object$param_names
  ...
  include_nuisance <- FALSE
   ...
   all_param_outs_trace <- SOMETHING ##  ---------------------------------- BOOKMARK
  ...
  if (compute_main_params == TRUE) { 
        ...
        summary_tibble_main_params <- MetaOrdinal:::generate_summary_tibble(   n_threads = n_cores,
  ...
  if  ((compute_generated_quantities == TRUE) && (n_gq > 0))  { 
        ...
        summary_tibble_generated_quantities <- MetaOrdinal:::generate_summary_tibble(    n_threads = n_cores,
                                                                                      trace = trace_gq,
  ...
  if ((compute_transformed_parameters == TRUE) && (n_tp > 0)) {
        ...
        summary_tibble_transformed_parameters <- MetaOrdinal:::generate_summary_tibble(      n_threads = n_cores,
                                                                                          trace = trace_tp,
