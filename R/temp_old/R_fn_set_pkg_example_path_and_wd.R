...
set_pkg_example_path_and_wd <- function() {
        ...
        user_MetaOrdinal_dir <- file.path(user_root_dir, "BayesMVP")
        print(paste("user_MetaOrdinal_dir = ", user_MetaOrdinal_dir))
        
        pkg_example_path <- file.path(user_MetaOrdinal_dir, "examples")
        ...
        outs <- list(user_root_dir = user_root_dir,
                     user_MetaOrdinal_dir = user_MetaOrdinal_dir,
